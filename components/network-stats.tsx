...
export function NetworkStats() {
  ...
  if (isDesktop) {
    return (
      <motion.div
        className="absolute left-4 top-80 z-20 max-w-xs height-responsive-scale"
            ...
            <div className="mb-4">
              ...
              <div className="relative mb-4">
                <div className="w-full bg-gray-800 rounded-full h-3 overflow-hidden">
                  ...
                  {baseProgress < 100 && (
                    <motion.div
                      className={`h-3 ${isAhead ? "bg-green-500" : "bg-red-500"} inline-block`}
                      initial={{ width: 0 }}
  ...
  return (
    <motion.div
      className="absolute left-0 top-64 z-10 w-full px-4"
          ...
          <div className="mb-0">
            ...
            <div className="relative mb-2">
              <div className="w-full bg-gray-800 rounded-full h-2 overflow-hidden">
                ...
                {baseProgress < 100 && (
                  <motion.div
                    className={`h-2 ${isAhead ? "bg-green-500" : "bg-red-500"} inline-block`}
                    initial={{ width: 0 }}
                    animate={{ width: `${Math.min(extensionPercent, 100 - baseProgress)}%` }}
                    transition={{ duration: 1, ease: "easeOut", delay: 0.5 }}
                  />
