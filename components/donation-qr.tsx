        ...
        <div className="flex items-center justify-center space-x-2 mb-2">
          <div className="flex items-center justify-center space-x-1 rounded-md bg-neutral-700 p-1">
            <Button
              ...
              className={`px-2 py-1 text-xs h-auto ${qrType === "onchain" ? "bg-orange-500 text-white" : "bg-transparent text-neutral-400"}`}
              variant="ghost"
            >
              On-Chain
            </Button>
            <Button
              ...
              className={`px-2 py-1 text-xs h-auto ${qrType === "bolt11" ? "bg-orange-500 text-white" : "bg-transparent text-neutral-400"}`}
              variant="ghost"
            >
              Bolt11
            </Button>
